...
while PC_address < End_PC_address:
    ...
    if instruction[0:6] == '000000':
        ...
        if dictionary[instruction[0:6]] == 'move' or dictionary[instruction[0:6]] == 'addi' or dictionary[instruction[0:6]] == 'bne' or dictionary[instruction[0:6]] == 'beq' or dictionary[instruction[0:6]] == 'add' or dictionary[instruction[0:6]] == 'sub' or dictionary[instruction[0:6]] == 'lw':
...
# move, slt , bne , beq , addi , sub, lw, 

print(Register_to_PC)
print(Addre_to_reg)
